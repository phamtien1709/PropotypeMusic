	...
	*/
	Phaser.BitmapDataSoundAnalyze = function (game, key, width, height, soundAnalyser) {
		...
		*/
		...
		/**
		* @property {String|Hex} [frequencyDomainChartUniformColor="#3a1304"] - color for the frequency domain chart uniform
		*/
		this.frequencyDomainChartUniformColor = "#3a1304";
...
Phaser.Plugin.SoundAnalyse.prototype.add = {
	...
	*/
	soundAnalyseSprite: function (x, y, width, height, songKey, autoPlay, onDecodeComplete, context, group) {
	   ...
	   var soundAnalyseSprite = new Phaser.SoundAnalyseSprite(KT.game, x, y, width, height, songKey, autoPlay, onDecodeComplete, context);
